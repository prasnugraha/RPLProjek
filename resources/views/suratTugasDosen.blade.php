  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="nav-link active">
        ...
        <a> &nbsp > &nbsp</a>
        <a class="h5" href="/buatSuratDosen/suratTugasDosen" type="button" style="text-decoration:none">Surat Tugas</a>
      </div>
            <form method="post" action="/buatSuratDosen/simpanST">
      ...
      <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="hari_kgt" name="hari_kgt" placeholder="Masukkan Hari kegiatan">
                </div>
                <div class="mb-3">
