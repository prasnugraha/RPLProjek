  ...
  <div class="row">
      ...
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item active" href="/suratMasukDosen">Surat Masuk</a></li>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <a class="h5" href="#" type="button" style="text-decoration:none">Surat</a>
        <a> &nbsp > &nbsp</a>
        <a class="h5" href="/suratMasukDosen" type="button" style="text-decoration:none">Mengelolah Surat Masuk</a>
      </div>
        <table class="table">
            <thead>
                <tr>
