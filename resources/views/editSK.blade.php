  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="nav-link active">
        ...
        <a> &nbsp > &nbsp</a>
        <a class="h5" href="/suratKeluar/editSK/{{$k->id_surat}}" type="button" style="text-decoration:none">Edit Surat</a>
      </div>
        <form method="post" action="/suratKeluar/update">
            ...
            <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control"  name="hari_kgt" value="{{$k->hari_kgt}}" placeholder="Masukkan Hari kegiatan">
                </div>
                <div class="mb-3">
