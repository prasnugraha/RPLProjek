  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="/buatSuratMahasiswa">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="nav-link active">
        <a class="h5" href="/buatSuratMahasiswa" type="button" style="text-decoration:none">Jenis-Surat</a>
      </div>
     <br><br>
      <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                <center>
                    ...
                    <a class="btn btn-primary me-md-2" href="/buatSuratMahasiswa/suratTugas" role="button">Buat Surat</a>
                </center>
				<br/>
			</div>
            <div class="col-md-2">
                <center>
                    ...
                    <a class="btn btn-primary me-md-2" href="/buatSuratMahasiswa/suratPersonalia" role="button">Buat Surat</a>
                </center>
				<br/>
			</div>
            <div class="col-md-2">
                <center>
                    ...
                    <a class="btn btn-primary me-md-2" href="/buatSuratMahasiswa/suratUndangan" role="button">Buat Surat</a>
                </center>
				<br/>
			</div>
      </div><br><br>
      <div class="row">
            ...
            <div class="col-md-2">
                <center>
                    ...
                    <a class="btn btn-primary me-md-2" href="/buatSuratMahasiswa/suratKKM" role="button">Buat Surat</a>
                </center>
				<br/>
            </div>
            <div class="col-md-2">
                <center>
                    ...
                    <a class="btn btn-primary me-md-2" href="/buatSuratMahasiswa/beritaAcara" role="button">Buat Surat</a>
                </center>
				<br/>
			</div>
    </main>
